...
<div class="container documentation-container" style="min-height: 700px;">
    ...
    <a href="<?= base_url('assets/Web Platform.pdf') ?>" class="btn btn-primary doc-link mt-4" target="_blank">
        Web Platform Documentation
    </a>

    <a href="<?= base_url('assets/Documentation AGI V5.2.pdf') ?>" class="btn btn-primary doc-link mt-4" target="_blank">
